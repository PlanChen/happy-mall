...
public class GenUtils {
    ...
    public static List<String> getTemplates(){
        ...
        templates.add("template/QueryBean.java.vm");
        templates.add("template/Vo.java.vm");
        templates.add("template/Dao.java.vm");
        templates.add("template/AppController.java.vm");
    ...
    public static String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        if (template.contains("QueryBean.java.vm" )) {
            return packagePath + "dto" + File.separator + className + "QueryBean.java";
        }
        ...
        if (template.contains("ApiController.java.vm" )) {
            return packagePath + "controller" + File.separator + className + "ApiController.java";
        }
