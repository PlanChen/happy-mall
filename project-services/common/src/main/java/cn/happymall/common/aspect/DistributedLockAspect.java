package cn.happymall.common.aspect;

import cn.happymall.common.annotation.DistributedLock;
import cn.happymall.common.lock.DistributedLockCallback;
import cn.happymall.common.lock.DistributedLockTemplate;
...
public class DistributedLockAspect {
    ...
    @Pointcut("@annotation(cn.happymall.common.annotation.DistributedLock)")
    ...
    public Object lock(ProceedingJoinPoint pjp, final String lockName, boolean fairLock) {
        return distributedLock.lock(new DistributedLockCallback<Object>() {
            @Override
    ...
    public Object tryLock(ProceedingJoinPoint pjp, DistributedLock annotation, final String lockName, boolean fairLock) {
        ...
        return distributedLock.tryLock(new DistributedLockCallback<Object>() {
            @Override
            public Object process() {
                return proceed(pjp);
            }
